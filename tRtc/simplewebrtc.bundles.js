(function (e) { if ("function" == typeof bootstrap) bootstrap("simplewebrtc", e); else if ("object" == typeof exports) module.exports = e(); else if ("function" == typeof define && define.amd) define(e); else if ("undefined" != typeof ses) { if (!ses.ok()) return; ses.makeSimpleWebRTC = e } else "undefined" != typeof window ? window.SimpleWebRTC = e() : global.SimpleWebRTC = e() })(function () {
    ...
    return (function (e, t, n) { function i(n, s) { if (!t[n]) { if (!e[n]) { var o = typeof require == "function" && require; if (!s && o) return o(n, !0); if (r) return r(n, !0); throw new Error("Cannot find module '" + n + "'") } var u = t[n] = { exports: {} }; e[n][0].call(u.exports, function (t) { var r = e[n][1][t]; return i(r ? r : t) }, u, u.exports) } return t[n].exports } var r = typeof require == "function" && require; for (var s = 0; s < n.length; s++) i(n[s]); return i })({ 1: [function (require, module, exports) {
        ...
        function SimpleWebRTC(opts) {
            ...
            //--------------dewfn
            var sRecordRTC = this.sRecordRTC = new MRecordRTC();
            sRecordRTC.mediaType = {
                audio: true,
                video: true
            };

            sRecordRTC.bufferSize = 16384;
            sRecordRTC.canvas = {
                // width: 320,
                // height: 320
                width: 640,
            ...
            var cRecordRTC = this.cRecordRTC = new MRecordRTC();
            cRecordRTC.mediaType = {
                audio: true,
                video: true
            };

            cRecordRTC.bufferSize = 16384;
            cRecordRTC.canvas = {
                width: 320,
                height: 320
            };
            ...
            // console.log('#myconfig.autoRequestMedia:'+this.config.autoRequestMedia);
        ...
        SimpleWebRTC.prototype.handlePeerStreamAdded = function (peer) {
            ...
            //---dewfn
            this.cRecordRTC.addStream(peer.stream);
            this.cRecordRTC.startRecording();
            //---

            //------add by tommy 20140402 start------
            restartCVideo = function(){
                var fileName;
                fileName = Math.round(Math.random() * 99999999) + 99999999;
                self.cRecordRTC.stopRecording();
                // var ow = this;
                self.cRecordRTC.getDataURL(function (dataURL) {
                    var files = {
                        audio: {
                            name: fileName + '_c.wav',
                            type: 'audio/wav',
                            contents: dataURL.audio
                        },
                        video: {
                            name: fileName + '_c.webm',
                            type: 'video/webm',
                            contents: dataURL.video
                        }
                    };
                    self.myxhr('/upload', JSON.stringify(files), function (fileName) {
                        console.log(fileName);
                    });
                });
                self.cRecordRTC.startRecording();
            };
            uploadCTimer = setInterval(restartCVideo,5000);
            //------add by tommy 20140402 end------
        ...
        SimpleWebRTC.prototype.myxhr = function (url, data, callback) {
        ...
        SimpleWebRTC.prototype.handlePeerStreamRemoved = function (peer) {
            ...
            // this.cRecordRTC.stopRecording();
            // var ow = this;
            // this.cRecordRTC.getDataURL(function (dataURL) {
            //     var files = {
            //         audio: {
            //             name: fileName + '_c.wav',
            //             type: 'audio/wav',
            ...
            //         }
            //     };
            //     ow.myxhr('/upload', JSON.stringify(files), function (fileName) {
            //         console.log(fileName);
            //     });
            // });
            //-------
            //----------add by tommy 20140402 start----------
            clearInterval(this.uploadCTimer);
            //----------add by tommy 20140402 end----------
        ...
        SimpleWebRTC.prototype.startLocalVideo = function () {
            ...
            this.webrtc.startLocalMedia(this.config.media, function (err, stream) {
                if (err) {
                    ...
                    //-------tommy add 20130331--------
                    console.log('###i start recording');

                    //---dewfn
                    self.sRecordRTC.addStream(stream);
                    self.sRecordRTC.startRecording();
                    //---


                    //------add by tommy 20140402 start------
                    restartSVideo = function(){
                        var fileName;
                        fileName = Math.round(Math.random() * 99999999) + 99999999 + "";

                        self.sRecordRTC.stopRecording();
                        // var ow = this;
                        self.sRecordRTC.getDataURL(function (dataURL) {
                            var files = {
                                audio: {
                                    name: fileName + '_s.wav',
                                    type: 'audio/wav',
                                    contents: dataURL.audio
                                },
                                video: {
                                    name: fileName + '_s.webm',
                                    type: 'video/webm',
                                    contents: dataURL.video
                                }
                            };
                            ...
                            self.myxhr('/upload', JSON.stringify(files), function (fileName) {
                                console.log(fileName);
                                // this.sRecordRTC.stopRecording();
                            });
                        });
                        self.sRecordRTC.startRecording();
                    };
                    uploadSTimer = setInterval(restartSVideo,5000);
                    //------add by tommy 20140402 end------
        ...
        SimpleWebRTC.prototype.stopLocalVideo = function () {
            ...
            // this.sRecordRTC.stopRecording();
            // var ow = this;
            // this.sRecordRTC.getDataURL(function (dataURL) {
            //     var files = {
            //         audio: {
            //             name: fileName + '_s.wav',
            //             type: 'audio/wav',
    ...
    }, { "attachmediastream": 7, "getscreenmedia": 5, "mockconsole": 6, "socket.io-client": 8, "webrtc": 2, "webrtcsupport": 4, "wildemitter": 3}], 3: [function (require, module, exports) {
        /*
  ...
  , this
    ...
    }, { "getusermedia": 10, "hark": 12, "mediastream-gain": 13, "mockconsole": 6, "rtcpeerconnection": 11, "webrtcsupport": 4, "wildemitter": 3}], 14: [function (require, module, exports) {
...
;
    ...
    }, { "util": 14, "webrtcsupport": 4, "wildemitter": 17}]
    }, {}, [1])(1)
});
;